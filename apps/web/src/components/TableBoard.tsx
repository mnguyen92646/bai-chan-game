...
export function TableBoard(props: {
  ...
  return (
    <div className="relative w-full h-[62vh] min-h-[520px] overflow-hidden rounded-2xl border border-black/20 shadow-sm">
      ...
      {/* No giant center last-discard panel. Discards live in the "gates" between players.
          Tap any tile (hand, melds, discards) to highlight matches everywhere. */}
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  {meldTiles.slice(-10).map((t, idx) => (
                    <button
                      ...
                      title={t}
                      onClick={() => props.setFocusDiscard(props.focusDiscard === t ? "" : t)}
                    >
