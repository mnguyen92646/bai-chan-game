...
Play the [public game](https://bai-chan-play.white-violet-3211.workers.dev/) or read the [research note and family rules](https://michaelnguyen.net/baichan.html). If your family plays with this deck, [share your rules](https://bai-chan-rules.white-violet-3211.workers.dev/?lang=en). Code contributions are welcome; start with [CONTRIBUTING.md](CONTRIBUTING.md).

Source code and documentation are MIT licensed. Card art and audio are excluded from that license; see [LICENSE](LICENSE) and [media rights](MEDIA_RIGHTS.md).
